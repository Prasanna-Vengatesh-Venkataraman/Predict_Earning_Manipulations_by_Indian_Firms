#Package and librariy installations
...
str(ML)
options(scipen = 99)
#All variables are now present in correct format.
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#c) Stepwise logistic regression model with sample data
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#f)M-score (Manipulator score) that can be used by regulators to identify potential manipulators

#Given, M-score is the value of the linear combination of statically significant variables corresponding to the cut-off probability that is chosen to classify between manipulators and non-manipulators
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#h)Logistic regression model using the complete data set
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#i)Ensemble machine learning algorithms
